                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-3xl p-1 pr-6 w-fit h-fit backdrop-blur-xl">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Total Results</span>
                            <span className="text-lg font-black text-white italic leading-none">{total.toLocaleString()}</span>
                        </div>
                        <div className="w-px h-8 bg-white/10 mx-2" />
                        <div className="flex flex-col">
                            <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Total Pages</span>
