            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <div className="flex-1 flex flex-col gap-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        {/* Source Code Promotion Banner */}
                        <div className="sm:col-span-2 bg-gradient-to-br from-indigo-600/20 via-primary/10 to-purple-600/20 border border-white/10 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-6 relative overflow-hidden group shadow-2xl shadow-primary/5">
                            <div className="absolute inset-0 bg-batik-pink opacity-[0.08] pointer-events-none group-hover:opacity-[0.12] transition-all" />
                            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 blur-[80px] -mr-32 -mt-32 group-hover:bg-primary/20 transition-all duration-1000" />
                            
                            <div className="flex items-center gap-5 z-10">
                                <div className="w-14 h-14 bg-white text-black rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(255,255,255,0.2)] shrink-0 transform group-hover:rotate-6 transition-transform">
                                ...
                                <div className="flex flex-col gap-1">
                                    <div className="flex items-center gap-2">
                                        <h3 className="text-lg font-black text-white tracking-tight uppercase italic">Own This Website SC</h3>
                                        <span className="bg-primary text-black text-[10px] font-black px-2 py-0.5 rounded-full shadow-lg shadow-primary/20 animate-pulse">LIMITED</span>
                                    </div>
                                    <p className="text-xs text-zinc-400 font-medium leading-relaxed max-w-md">
                                        Ingin punya web cuan sendiri? Dapatkan Source Code full fitur, anti-bot, dashboard premium, & sistem earning otomatis.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col items-center sm:items-end gap-3 z-10">
                                <div className="flex flex-col items-center sm:items-end -gap-1">
                                    <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Special Price</span>
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-xs font-bold text-zinc-400">$</span>
                                        <span className="text-3xl font-black text-white tracking-tighter">{(settings?.scPromoPrice || "150")}</span>
                                        <span className="text-xs font-bold text-primary">.00</span>
                                    </div>
                                </div>
                                <a 
                                    href={settings?.scPromoLink || "https://t.me/pongo_official"}
                                    target="_blank"
                                    className="w-full sm:w-auto px-6 py-3 bg-white text-black font-black text-xs uppercase tracking-widest rounded-xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 shadow-xl shadow-white/5"
                                >
                                    <svg className="w-4 h-4 fill-[#0088cc]" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.17c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .38z"/></svg>
                                    Buy Now via Tele
                                </a>
                            </div>
                        </div>
